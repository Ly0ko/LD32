...
Void TestLevel_obj::__construct(Dynamic level)
{
HX_STACK_FRAME("TestLevel","new",0xe4dc95a4,"TestLevel.new","TestLevel.hx",25,0x6174ea4c)
HX_STACK_THIS(this)
...
//TestLevel_obj::~TestLevel_obj() { }

Dynamic TestLevel_obj::__CreateEmpty() { return  new TestLevel_obj; }
hx::ObjectPtr< TestLevel_obj > TestLevel_obj::__new(Dynamic level)
{  hx::ObjectPtr< TestLevel_obj > result = new TestLevel_obj();
	result->__construct(level);
	return result;}

Dynamic TestLevel_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< TestLevel_obj > result = new TestLevel_obj();
	result->__construct(inArgs[0]);
	return result;}

::String TestLevel_obj::c_PATH_LEVEL_TILESHEETS;
...
void TestLevel_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(TestLevel);
...
void TestLevel_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic TestLevel_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic TestLevel_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 15:
...
void TestLevel_obj::__GetFields(Array< ::String> &outFields)
{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::flixel::group::FlxGroup*/ ,(int)offsetof(TestLevel_obj,foregroundTiles),HX_CSTRING("foregroundTiles")},
	{hx::fsObject /*::flixel::group::FlxGroup*/ ,(int)offsetof(TestLevel_obj,backgroundTiles),HX_CSTRING("backgroundTiles")},
	{hx::fsObject /*Array< ::Dynamic >*/ ,(int)offsetof(TestLevel_obj,collidableTileLayers),HX_CSTRING("collidableTileLayers")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(TestLevel_obj::__mClass,"__mClass");
	HX_MARK_MEMBER_NAME(TestLevel_obj::c_PATH_LEVEL_TILESHEETS,"c_PATH_LEVEL_TILESHEETS");
};

#ifdef HXCPP_VISIT_ALLOCS
static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(TestLevel_obj::__mClass,"__mClass");
	HX_VISIT_MEMBER_NAME(TestLevel_obj::c_PATH_LEVEL_TILESHEETS,"c_PATH_LEVEL_TILESHEETS");
};

#endif

Class TestLevel_obj::__mClass;

void TestLevel_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("TestLevel"), hx::TCanCast< TestLevel_obj> ,sStaticFields,sMemberFields,
