...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(22)
		::openfl::_legacy::Lib_obj::setPackage(HX_CSTRING("HaxeFlixel"),HX_CSTRING("LD32"),HX_CSTRING("com.example.myapp"),HX_CSTRING("0.0.1"));
