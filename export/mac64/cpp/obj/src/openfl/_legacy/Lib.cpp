...
Dynamic Lib_obj::as( Dynamic v,::Class c){
	HX_STACK_FRAME("openfl._legacy.Lib","as",0xb50de57f,"openfl._legacy.Lib.as","openfl/_legacy/Lib.hx",54,0x739f021f)
	HX_STACK_ARG(v,"v")
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(54)
	return v;
...
::openfl::_legacy::display::MovieClip Lib_obj::attach( ::String name){
	HX_STACK_FRAME("openfl._legacy.Lib","attach",0x82a556d2,"openfl._legacy.Lib.attach","openfl/_legacy/Lib.hx",61,0x739f021f)
...
Void Lib_obj::close( ){
{
		HX_STACK_FRAME("openfl._legacy.Lib","close",0x05629d4b,"openfl._legacy.Lib.close","openfl/_legacy/Lib.hx",66,0x739f021f)
		HX_STACK_LINE(68)
		::openfl::_legacy::display::Stage_obj::__exiting = true;
		HX_STACK_LINE(69)
		Dynamic close = ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_close"),(int)0);		HX_STACK_VAR(close,"close");
		HX_STACK_LINE(70)
		close();
	}
return null();
...
::String title = __o_title.Default(HX_CSTRING("OpenFL"));
	HX_STACK_FRAME("openfl._legacy.Lib","create",0x1ea4c209,"openfl._legacy.Lib.create","openfl/_legacy/Lib.hx",75,0x739f021f)
	...
	HX_STACK_ARG(stageClass,"stageClass")
{
		...
		HX_STACK_LINE(94)
		Dynamic create_main_frame = ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_create_main_frame"),(int)-1);		HX_STACK_VAR(create_main_frame,"create_main_frame");
		...
		Void run(Dynamic frameHandle){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/_legacy/Lib.hx",98,0x739f021f)
...
int flags = __o_flags.Default(0);
	HX_STACK_FRAME("openfl._legacy.Lib","createManagedStage",0x7e03c788,"openfl._legacy.Lib.createManagedStage","openfl/_legacy/Lib.hx",127,0x739f021f)
	HX_STACK_ARG(width,"width")
	HX_STACK_ARG(height,"height")
	HX_STACK_ARG(flags,"flags")
{
...
::String Lib_obj::findHaxeLib( ::String library){
	HX_STACK_FRAME("openfl._legacy.Lib","findHaxeLib",0x9617a559,"openfl._legacy.Lib.findHaxeLib","openfl/_legacy/Lib.hx",154,0x739f021f)
...
int args = __o_args.Default(0);
	HX_STACK_FRAME("openfl._legacy.Lib","load",0x87b427f3,"openfl._legacy.Lib.load","openfl/_legacy/Lib.hx",195,0x739f021f)
	HX_STACK_ARG(library,"library")
...
{
		HX_STACK_FRAME("openfl._legacy.Lib","loaderTrace",0x37050745,"openfl._legacy.Lib.loaderTrace","openfl/_legacy/Lib.hx",282,0x739f021f)
...
{
		HX_STACK_FRAME("openfl._legacy.Lib","notImplemented",0x6d44ea7c,"openfl._legacy.Lib.notImplemented","openfl/_legacy/Lib.hx",302,0x739f021f)
		...
		if ((!(::openfl::_legacy::Lib_obj::__sentWarnings->exists(api)))){
			...
			HX_STACK_LINE(306)
			::haxe::Log_obj::trace(((HX_CSTRING("Warning: ") + api) + HX_CSTRING(" is not implemented")),hx::SourceInfo(HX_CSTRING("Lib.hx"),306,HX_CSTRING("openfl._legacy.Lib"),HX_CSTRING("notImplemented")));
		}
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl._legacy.Lib","rethrow",0x964500e6,"openfl._legacy.Lib.rethrow","openfl/_legacy/Lib.hx",313,0x739f021f)
...
{
		HX_STACK_FRAME("openfl._legacy.Lib","setUncaughtExceptionHandler",0x766b3585,"openfl._legacy.Lib.setUncaughtExceptionHandler","openfl/_legacy/Lib.hx",361,0x739f021f)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(361)
...
::String Lib_obj::sysName( ){
	HX_STACK_FRAME("openfl._legacy.Lib","sysName",0x1a5aa64b,"openfl._legacy.Lib.sysName","openfl/_legacy/Lib.hx",366,0x739f021f)
	HX_STACK_LINE(369)
...
Dynamic Lib_obj::tryLoad( ::String name,::String library,::String func,int args){
	HX_STACK_FRAME("openfl._legacy.Lib","tryLoad",0xea903954,"openfl._legacy.Lib.tryLoad","openfl/_legacy/Lib.hx",378,0x739f021f)
	HX_STACK_ARG(name,"name")
	HX_STACK_ARG(library,"library")
...
Void Lib_obj::exit( ){
{
		HX_STACK_FRAME("openfl._legacy.Lib","exit",0x831a84eb,"openfl._legacy.Lib.exit","openfl/_legacy/Lib.hx",437,0x739f021f)
		HX_STACK_LINE(439)
...
{
		HX_STACK_FRAME("openfl._legacy.Lib","forceClose",0xe34c675a,"openfl._legacy.Lib.forceClose","openfl/_legacy/Lib.hx",458,0x739f021f)
		HX_STACK_LINE(460)
		Dynamic terminate = ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_terminate"),(int)0);		HX_STACK_VAR(terminate,"terminate");
		HX_STACK_LINE(461)
		terminate();
	}
return null();
...
int Lib_obj::getTimer( ){
	HX_STACK_FRAME("openfl._legacy.Lib","getTimer",0xe6f8c79c,"openfl._legacy.Lib.getTimer","openfl/_legacy/Lib.hx",466,0x739f021f)
	HX_STACK_LINE(470)
...
{
		HX_STACK_FRAME("openfl._legacy.Lib","getURL",0x45bda386,"openfl._legacy.Lib.getURL","openfl/_legacy/Lib.hx",477,0x739f021f)
...
Void Lib_obj::pause( ){
{
		HX_STACK_FRAME("openfl._legacy.Lib","pause",0x7a575c89,"openfl._legacy.Lib.pause","openfl/_legacy/Lib.hx",484,0x739f021f)
		HX_STACK_LINE(484)
...
{
		HX_STACK_FRAME("openfl._legacy.Lib","postUICallback",0xf68580a6,"openfl._legacy.Lib.postUICallback","openfl/_legacy/Lib.hx",494,0x739f021f)
...
Void Lib_obj::resume( ){
{
		HX_STACK_FRAME("openfl._legacy.Lib","resume",0xab19c4ba,"openfl._legacy.Lib.resume","openfl/_legacy/Lib.hx",502,0x739f021f)
		HX_STACK_LINE(502)
...
{
		HX_STACK_FRAME("openfl._legacy.Lib","setIcon",0xab51788e,"openfl._legacy.Lib.setIcon","openfl/_legacy/Lib.hx",507,0x739f021f)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(509)
		Dynamic set_icon = ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_set_icon"),(int)1);		HX_STACK_VAR(set_icon,"set_icon");
		HX_STACK_LINE(510)
		set_icon(path);
	}
return null();
...
{
		HX_STACK_FRAME("openfl._legacy.Lib","setPackage",0x98a4b591,"openfl._legacy.Lib.setPackage","openfl/_legacy/Lib.hx",515,0x739f021f)
...
{
		HX_STACK_FRAME("openfl._legacy.Lib","__setCurrentStage",0x3b62697a,"openfl._legacy.Lib.__setCurrentStage","openfl/_legacy/Lib.hx",529,0x739f021f)
...
{
		HX_STACK_FRAME("openfl._legacy.Lib","trace",0xd31f1418,"openfl._legacy.Lib.trace","openfl/_legacy/Lib.hx",536,0x739f021f)
		HX_STACK_ARG(arg,"arg")
		HX_STACK_LINE(536)
		::haxe::Log_obj::trace(arg,hx::SourceInfo(HX_CSTRING("Lib.hx"),536,HX_CSTRING("openfl._legacy.Lib"),HX_CSTRING("trace")));
	}
return null();
}
...
::openfl::_legacy::display::MovieClip Lib_obj::get_current( ){
	HX_STACK_FRAME("openfl._legacy.Lib","get_current",0xdfa27223,"openfl._legacy.Lib.get_current","openfl/_legacy/Lib.hx",548,0x739f021f)
	HX_STACK_LINE(550)
	if (((::openfl::_legacy::Lib_obj::__current == null()))){
		HX_STACK_LINE(552)
...
::openfl::_legacy::display::Stage Lib_obj::get_stage( ){
	HX_STACK_FRAME("openfl._legacy.Lib","get_stage",0x5f421228,"openfl._legacy.Lib.get_stage","openfl/_legacy/Lib.hx",567,0x739f021f)
	HX_STACK_LINE(569)
	if (((::openfl::_legacy::Lib_obj::__stage == null()))){
		HX_STACK_LINE(571)
...
void Lib_obj::__boot()
{
	...
	lime_set_package= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_set_package"),(int)4);
	lime_get_frame_stage= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_get_frame_stage"),(int)1);
	lime_get_url= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_get_url"),(int)1);
	lime_pause_animation= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_pause_animation"),(int)0);
	lime_resume_animation= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_resume_animation"),(int)0);
}
