...
{
HX_STACK_FRAME("openfl._legacy.media.Sound","new",0xac494db3,"openfl._legacy.media.Sound.new","openfl/_legacy/media/Sound.hx",38,0xdb1efaa0)
HX_STACK_THIS(this)
...
bool useWeakReference = __o_useWeakReference.Default(false);
	HX_STACK_FRAME("openfl._legacy.media.Sound","addEventListener",0xf036769a,"openfl._legacy.media.Sound.addEventListener","openfl/_legacy/media/Sound.hx",58,0xdb1efaa0)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.media.Sound","close",0xfab0cfcb,"openfl._legacy.media.Sound.close","openfl/_legacy/media/Sound.hx",78,0xdb1efaa0)
		HX_STACK_THIS(this)
		HX_STACK_LINE(80)
		if (((this->__handle != null()))){
			HX_STACK_LINE(82)
...
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
	HX_STACK_FRAME("openfl._legacy.media.Sound","load",0x128fc573,"openfl._legacy.media.Sound.load","openfl/_legacy/media/Sound.hx",92,0xdb1efaa0)
	HX_STACK_THIS(this)
	HX_STACK_ARG(stream,"stream")
	HX_STACK_ARG(context,"context")
	HX_STACK_ARG(forcePlayAsMusic,"forcePlayAsMusic")
{
		...
		if (((this->__handle == null()))){
			HX_STACK_LINE(101)
			::haxe::Log_obj::trace(((HX_CSTRING("Error: Could not load \"") + stream->url) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Sound.hx"),101,HX_CSTRING("openfl._legacy.media.Sound"),HX_CSTRING("load")));
			HX_STACK_LINE(102)
...
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
	HX_STACK_FRAME("openfl._legacy.media.Sound","loadCompressedDataFromByteArray",0x906313a9,"openfl._legacy.media.Sound.loadCompressedDataFromByteArray","openfl/_legacy/media/Sound.hx",118,0xdb1efaa0)
	HX_STACK_THIS(this)
...
Float sampleRate = __o_sampleRate.Default(44100.0);
	HX_STACK_FRAME("openfl._legacy.media.Sound","loadPCMFromByteArray",0x1758a6c0,"openfl._legacy.media.Sound.loadPCMFromByteArray","openfl/_legacy/media/Sound.hx",134,0xdb1efaa0)
	HX_STACK_THIS(this)
	HX_STACK_ARG(bytes,"bytes")
...
int loops = __o_loops.Default(0);
	HX_STACK_FRAME("openfl._legacy.media.Sound","play",0x15325941,"openfl._legacy.media.Sound.play","openfl/_legacy/media/Sound.hx",182,0xdb1efaa0)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.media.Sound","__checkLoading",0xfefc3741,"openfl._legacy.media.Sound.__checkLoading","openfl/_legacy/media/Sound.hx",233,0xdb1efaa0)
		HX_STACK_THIS(this)
		HX_STACK_LINE(233)
...
{
		HX_STACK_FRAME("openfl._legacy.media.Sound","__onError",0x92dc789c,"openfl._legacy.media.Sound.__onError","openfl/_legacy/media/Sound.hx",258,0xdb1efaa0)
		HX_STACK_THIS(this)
...
::openfl::media::ID3Info Sound_obj::get_id3( ){
	HX_STACK_FRAME("openfl._legacy.media.Sound","get_id3",0x51feef62,"openfl._legacy.media.Sound.get_id3","openfl/_legacy/media/Sound.hx",274,0xdb1efaa0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(276)
	this->__checkLoading();
	HX_STACK_LINE(278)
...
bool Sound_obj::get_isBuffering( ){
	HX_STACK_FRAME("openfl._legacy.media.Sound","get_isBuffering",0x33178c02,"openfl._legacy.media.Sound.get_isBuffering","openfl/_legacy/media/Sound.hx",291,0xdb1efaa0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(293)
	this->__checkLoading();
	HX_STACK_LINE(294)
...
Float Sound_obj::get_length( ){
	HX_STACK_FRAME("openfl._legacy.media.Sound","get_length",0xa94e27bc,"openfl._legacy.media.Sound.get_length","openfl/_legacy/media/Sound.hx",299,0xdb1efaa0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(301)
	if (((bool((this->__handle == null())) || bool(this->__loading)))){
		HX_STACK_LINE(303)
...
{
	lime_sound_from_file= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_sound_from_file"),(int)2);
	lime_sound_from_data= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_sound_from_data"),(int)3);
	lime_sound_get_id3= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_sound_get_id3"),(int)2);
	lime_sound_get_length= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_sound_get_length"),(int)1);
	lime_sound_close= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_sound_close"),(int)1);
	lime_sound_get_status= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_sound_get_status"),(int)1);
	lime_sound_channel_create_dynamic= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_sound_channel_create_dynamic"),(int)2);
}
