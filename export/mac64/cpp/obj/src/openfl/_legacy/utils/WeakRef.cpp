...
bool makeWeak = __o_makeWeak.Default(true);
{
	...
	if ((makeWeak)){
		HX_STACK_LINE(18)
		Dynamic _g = ::openfl::_legacy::utils::WeakRef_obj::lime_weak_ref_create(hx::ObjectPtr<OBJ_>(this),object);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(18)
		this->weakRef = _g;
		HX_STACK_LINE(19)
		this->hardRef = null();
...
Dynamic WeakRef_obj::get( ){
	...
	HX_STACK_LINE(45)
	Dynamic result = ::openfl::_legacy::utils::WeakRef_obj::lime_weak_ref_get(this->weakRef);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(46)
	if (((result == null()))){
		HX_STACK_LINE(48)
		this->weakRef = (int)-1;
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.utils.WeakRef"), hx::TCanCast< WeakRef_obj> ,sStaticFields,sMemberFields,
...
{
	lime_weak_ref_create= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_weak_ref_create"),(int)2);
	lime_weak_ref_get= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_weak_ref_get"),(int)1);
}
