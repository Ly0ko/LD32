...
{
	lime_stage_get_multitouch_supported= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_multitouch_supported"),(int)1);
	lime_stage_get_multitouch_active= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_multitouch_active"),(int)1);
	lime_stage_set_multitouch_active= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_set_multitouch_active"),(int)2);
}
