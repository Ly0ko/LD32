...
{
HX_STACK_FRAME("openfl._legacy.text.TextField","new",0xbac2ed82,"openfl._legacy.text.TextField.new","openfl/_legacy/text/TextField.hx",48,0xa9138a6d)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(50)
	Dynamic _g = ::openfl::_legacy::text::TextField_obj::lime_text_field_create();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(50)
...
{
		HX_STACK_FRAME("openfl._legacy.text.TextField","appendText",0xac177ac5,"openfl._legacy.text.TextField.appendText","openfl/_legacy/text/TextField.hx",59,0xa9138a6d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(text,"text")
		HX_STACK_LINE(61)
		::String _g = ::openfl::_legacy::text::TextField_obj::lime_text_field_get_text(this->__handle);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(61)
		::String _g1 = (_g + text);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(61)
		::openfl::_legacy::text::TextField_obj::lime_text_field_set_text(this->__handle,_g1);
	}
return null();
}
...
int TextField_obj::getLineOffset( int lineIndex){
	HX_STACK_FRAME("openfl._legacy.text.TextField","getLineOffset",0x9c398a7f,"openfl._legacy.text.TextField.getLineOffset","openfl/_legacy/text/TextField.hx",68,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lineIndex,"lineIndex")
	HX_STACK_LINE(68)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_line_offset(this->__handle,lineIndex);
}
...
::String TextField_obj::getLineText( int lineIndex){
	HX_STACK_FRAME("openfl._legacy.text.TextField","getLineText",0x4e7aec99,"openfl._legacy.text.TextField.getLineText","openfl/_legacy/text/TextField.hx",75,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lineIndex,"lineIndex")
	HX_STACK_LINE(75)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_line_text(this->__handle,lineIndex);
}
...
::openfl::_legacy::text::TextLineMetrics TextField_obj::getLineMetrics( int lineIndex){
	HX_STACK_FRAME("openfl._legacy.text.TextField","getLineMetrics",0x6b8f3dd7,"openfl._legacy.text.TextField.getLineMetrics","openfl/_legacy/text/TextField.hx",80,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lineIndex,"lineIndex")
	HX_STACK_LINE(82)
	::openfl::_legacy::text::TextLineMetrics result = ::openfl::_legacy::text::TextLineMetrics_obj::__new(null(),null(),null(),null(),null(),null());		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(83)
	::openfl::_legacy::text::TextField_obj::lime_text_field_get_line_metrics(this->__handle,lineIndex,result);
	HX_STACK_LINE(84)
	return result;
}
...
int endIndex = __o_endIndex.Default(-1);
	HX_STACK_FRAME("openfl._legacy.text.TextField","getTextFormat",0x9bd1079c,"openfl._legacy.text.TextField.getTextFormat","openfl/_legacy/text/TextField.hx",89,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(beginIndex,"beginIndex")
	HX_STACK_ARG(endIndex,"endIndex")
{
		HX_STACK_LINE(91)
		::openfl::_legacy::text::TextFormat result = ::openfl::_legacy::text::TextFormat_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(result,"result");
		HX_STACK_LINE(92)
		::openfl::_legacy::text::TextField_obj::lime_text_field_get_text_format(this->__handle,result,beginIndex,endIndex);
		HX_STACK_LINE(94)
		{
			HX_STACK_LINE(94)
			...
			while((true)){
				...
				HX_STACK_LINE(94)
				::openfl::_legacy::text::Font font = _g1->__get(_g).StaticCast< ::openfl::_legacy::text::Font >();		HX_STACK_VAR(font,"font");
				HX_STACK_LINE(94)
				++(_g);
				HX_STACK_LINE(96)
...
{
		HX_STACK_FRAME("openfl._legacy.text.TextField","replaceText",0xfff97a23,"openfl._legacy.text.TextField.replaceText","openfl/_legacy/text/TextField.hx",111,0xa9138a6d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(beginIndex,"beginIndex")
		HX_STACK_ARG(endIndex,"endIndex")
		HX_STACK_ARG(newText,"newText")
		HX_STACK_LINE(111)
		::openfl::_legacy::Lib_obj::notImplemented(HX_CSTRING("TextField.replaceText"));
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl._legacy.text.TextField","setSelection",0xab93e6e8,"openfl._legacy.text.TextField.setSelection","openfl/_legacy/text/TextField.hx",118,0xa9138a6d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(beginIndex,"beginIndex")
		HX_STACK_ARG(endIndex,"endIndex")
		HX_STACK_LINE(118)
		::openfl::_legacy::Lib_obj::notImplemented(HX_CSTRING("TextField.setSelection"));
	}
return null();
}
...
int beginIndex = __o_beginIndex.Default(-1);
int endIndex = __o_endIndex.Default(-1);
	HX_STACK_FRAME("openfl._legacy.text.TextField","setTextFormat",0xe0d6e9a8,"openfl._legacy.text.TextField.setTextFormat","openfl/_legacy/text/TextField.hx",123,0xa9138a6d)
	HX_STACK_THIS(this)
	...
	HX_STACK_ARG(endIndex,"endIndex")
{
		...
		HX_STACK_LINE(139)
		::openfl::_legacy::text::TextField_obj::lime_text_field_set_text_format(this->__handle,format,beginIndex,endIndex);
	}
return null();
}
...
::openfl::text::TextFieldAutoSize TextField_obj::get_autoSize( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(151)
	int _g = ::openfl::_legacy::text::TextField_obj::lime_text_field_get_auto_size(this->__handle);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(151)
...
::openfl::text::TextFieldAutoSize TextField_obj::set_autoSize( ::openfl::text::TextFieldAutoSize value){
	...
	HX_STACK_LINE(152)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_auto_size(this->__handle,_g);
	HX_STACK_LINE(152)
	return value;
}
...
bool TextField_obj::get_background( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_background",0x14dbae55,"openfl._legacy.text.TextField.get_background","openfl/_legacy/text/TextField.hx",153,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(153)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_background(this->__handle);
}
...
bool TextField_obj::set_background( bool value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_background",0x34fb96c9,"openfl._legacy.text.TextField.set_background","openfl/_legacy/text/TextField.hx",154,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(154)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_background(this->__handle,value);
	HX_STACK_LINE(154)
	return value;
}
...
int TextField_obj::get_backgroundColor( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_backgroundColor",0x63ed1ece,"openfl._legacy.text.TextField.get_backgroundColor","openfl/_legacy/text/TextField.hx",155,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(155)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_background_color(this->__handle);
}
...
int TextField_obj::set_backgroundColor( int value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_backgroundColor",0xa08a11da,"openfl._legacy.text.TextField.set_backgroundColor","openfl/_legacy/text/TextField.hx",156,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(156)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_background_color(this->__handle,value);
	HX_STACK_LINE(156)
	return value;
}
...
bool TextField_obj::get_border( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_border",0xa5b367d3,"openfl._legacy.text.TextField.get_border","openfl/_legacy/text/TextField.hx",157,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(157)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_border(this->__handle);
}
...
bool TextField_obj::set_border( bool value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_border",0xa9310647,"openfl._legacy.text.TextField.set_border","openfl/_legacy/text/TextField.hx",158,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(158)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_border(this->__handle,value);
	HX_STACK_LINE(158)
	return value;
}
...
int TextField_obj::get_borderColor( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_borderColor",0xce6e3c90,"openfl._legacy.text.TextField.get_borderColor","openfl/_legacy/text/TextField.hx",159,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(159)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_border_color(this->__handle);
}
...
int TextField_obj::set_borderColor( int value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_borderColor",0xca39b99c,"openfl._legacy.text.TextField.set_borderColor","openfl/_legacy/text/TextField.hx",160,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(160)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_border_color(this->__handle,value);
	HX_STACK_LINE(160)
	return value;
}
...
int TextField_obj::get_bottomScrollV( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_bottomScrollV",0x5b2b17f7,"openfl._legacy.text.TextField.get_bottomScrollV","openfl/_legacy/text/TextField.hx",161,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(161)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_bottom_scroll_v(this->__handle);
}
...
::openfl::_legacy::text::TextFormat TextField_obj::get_defaultTextFormat( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_defaultTextFormat",0xb2c5d85e,"openfl._legacy.text.TextField.get_defaultTextFormat","openfl/_legacy/text/TextField.hx",164,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(166)
	::openfl::_legacy::text::TextFormat result = ::openfl::_legacy::text::TextFormat_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(167)
	::openfl::_legacy::text::TextField_obj::lime_text_field_get_def_text_format(this->__handle,result);
	HX_STACK_LINE(169)
	{
		HX_STACK_LINE(169)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
::openfl::_legacy::text::TextFormat TextField_obj::set_defaultTextFormat( ::openfl::_legacy::text::TextFormat value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_defaultTextFormat",0x06cea66a,"openfl._legacy.text.TextField.set_defaultTextFormat","openfl/_legacy/text/TextField.hx",184,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(186)
	if (((value != null()))){
	...
	HX_STACK_LINE(200)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_def_text_format(this->__handle,value);
	HX_STACK_LINE(201)
	return value;
}
...
bool TextField_obj::get_displayAsPassword( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_displayAsPassword",0x927bdb88,"openfl._legacy.text.TextField.get_displayAsPassword","openfl/_legacy/text/TextField.hx",206,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(206)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_display_as_password(this->__handle);
}
...
bool TextField_obj::set_displayAsPassword( bool value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_displayAsPassword",0xe684a994,"openfl._legacy.text.TextField.set_displayAsPassword","openfl/_legacy/text/TextField.hx",207,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(207)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_display_as_password(this->__handle,value);
	HX_STACK_LINE(207)
	return value;
}
...
bool TextField_obj::get_embedFonts( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_embedFonts",0x7d9fe192,"openfl._legacy.text.TextField.get_embedFonts","openfl/_legacy/text/TextField.hx",208,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(208)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_embed_fonts(this->__handle);
}
...
bool TextField_obj::set_embedFonts( bool value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_embedFonts",0x9dbfca06,"openfl._legacy.text.TextField.set_embedFonts","openfl/_legacy/text/TextField.hx",209,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(209)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_embed_fonts(this->__handle,value);
	HX_STACK_LINE(209)
	return value;
}
...
::String TextField_obj::get_htmlText( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_htmlText",0xbe7b025f,"openfl._legacy.text.TextField.get_htmlText","openfl/_legacy/text/TextField.hx",210,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(210)
	::String _g = ::openfl::_legacy::text::TextField_obj::lime_text_field_get_html_text(this->__handle);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(210)
...
::String TextField_obj::set_htmlText( ::String value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_htmlText",0xd37425d3,"openfl._legacy.text.TextField.set_htmlText","openfl/_legacy/text/TextField.hx",211,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(211)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_html_text(this->__handle,value);
	HX_STACK_LINE(211)
	return value;
}
...
int TextField_obj::get_maxChars( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_maxChars",0x9e13d240,"openfl._legacy.text.TextField.get_maxChars","openfl/_legacy/text/TextField.hx",212,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(212)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_max_chars(this->__handle);
}
...
int TextField_obj::set_maxChars( int value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_maxChars",0xb30cf5b4,"openfl._legacy.text.TextField.set_maxChars","openfl/_legacy/text/TextField.hx",213,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(213)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_max_chars(this->__handle,value);
	HX_STACK_LINE(213)
	return value;
}
...
int TextField_obj::get_maxScrollH( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_maxScrollH",0x89bac7be,"openfl._legacy.text.TextField.get_maxScrollH","openfl/_legacy/text/TextField.hx",214,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(214)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_max_scroll_h(this->__handle);
}
...
int TextField_obj::get_maxScrollV( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_maxScrollV",0x89bac7cc,"openfl._legacy.text.TextField.get_maxScrollV","openfl/_legacy/text/TextField.hx",215,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(215)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_max_scroll_v(this->__handle);
}
...
bool TextField_obj::get_multiline( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_multiline",0x6a554266,"openfl._legacy.text.TextField.get_multiline","openfl/_legacy/text/TextField.hx",216,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(216)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_multiline(this->__handle);
}
...
bool TextField_obj::set_multiline( bool value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_multiline",0xaf5b2472,"openfl._legacy.text.TextField.set_multiline","openfl/_legacy/text/TextField.hx",217,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(217)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_multiline(this->__handle,value);
	HX_STACK_LINE(217)
	return value;
}
...
int TextField_obj::get_numLines( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_numLines",0xe054d480,"openfl._legacy.text.TextField.get_numLines","openfl/_legacy/text/TextField.hx",218,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(218)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_num_lines(this->__handle);
}
...
int TextField_obj::get_scrollH( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_scrollH",0x5536a2d4,"openfl._legacy.text.TextField.get_scrollH","openfl/_legacy/text/TextField.hx",219,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(219)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_scroll_h(this->__handle);
}
...
int TextField_obj::set_scrollH( int value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_scrollH",0x5fa3a9e0,"openfl._legacy.text.TextField.set_scrollH","openfl/_legacy/text/TextField.hx",220,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(220)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_scroll_h(this->__handle,value);
	HX_STACK_LINE(220)
	return value;
}
...
int TextField_obj::get_scrollV( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_scrollV",0x5536a2e2,"openfl._legacy.text.TextField.get_scrollV","openfl/_legacy/text/TextField.hx",221,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(221)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_scroll_v(this->__handle);
}
...
int TextField_obj::set_scrollV( int value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_scrollV",0x5fa3a9ee,"openfl._legacy.text.TextField.set_scrollV","openfl/_legacy/text/TextField.hx",222,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(222)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_scroll_v(this->__handle,value);
	HX_STACK_LINE(222)
	return value;
}
...
bool TextField_obj::get_selectable( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_selectable",0xb2e8d0fd,"openfl._legacy.text.TextField.get_selectable","openfl/_legacy/text/TextField.hx",223,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(223)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_selectable(this->__handle);
}
...
bool TextField_obj::set_selectable( bool value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_selectable",0xd308b971,"openfl._legacy.text.TextField.set_selectable","openfl/_legacy/text/TextField.hx",224,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(224)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_selectable(this->__handle,value);
	HX_STACK_LINE(224)
	return value;
}
...
::String TextField_obj::get_text( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_text",0xd17e8fd4,"openfl._legacy.text.TextField.get_text","openfl/_legacy/text/TextField.hx",225,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(225)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_text(this->__handle);
}
...
::String TextField_obj::set_text( ::String value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_text",0x7fdbe948,"openfl._legacy.text.TextField.set_text","openfl/_legacy/text/TextField.hx",226,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(226)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_text(this->__handle,value);
	HX_STACK_LINE(226)
	return value;
}
...
int TextField_obj::get_textColor( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_textColor",0xaf8d70ef,"openfl._legacy.text.TextField.get_textColor","openfl/_legacy/text/TextField.hx",227,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(227)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_text_color(this->__handle);
}
...
int TextField_obj::set_textColor( int value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_textColor",0xf49352fb,"openfl._legacy.text.TextField.set_textColor","openfl/_legacy/text/TextField.hx",228,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(228)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_text_color(this->__handle,value);
	HX_STACK_LINE(228)
	return value;
}
...
Float TextField_obj::get_textWidth( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_textWidth",0x2f93b592,"openfl._legacy.text.TextField.get_textWidth","openfl/_legacy/text/TextField.hx",229,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(229)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_text_width(this->__handle);
}
...
Float TextField_obj::get_textHeight( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_textHeight",0x27faa2db,"openfl._legacy.text.TextField.get_textHeight","openfl/_legacy/text/TextField.hx",230,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(230)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_text_height(this->__handle);
}
...
::openfl::text::TextFieldType TextField_obj::get_type( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(231)
	if ((::openfl::_legacy::text::TextField_obj::lime_text_field_get_type(this->__handle))){
		HX_STACK_LINE(231)
...
::openfl::text::TextFieldType TextField_obj::set_type( ::openfl::text::TextFieldType value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(232)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_type(this->__handle,(value == ::openfl::text::TextFieldType_obj::INPUT));
	HX_STACK_LINE(232)
	return value;
}
...
bool TextField_obj::get_wordWrap( ){
	HX_STACK_FRAME("openfl._legacy.text.TextField","get_wordWrap",0xaf1df75b,"openfl._legacy.text.TextField.get_wordWrap","openfl/_legacy/text/TextField.hx",233,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(233)
	return ::openfl::_legacy::text::TextField_obj::lime_text_field_get_word_wrap(this->__handle);
}
...
bool TextField_obj::set_wordWrap( bool value){
	HX_STACK_FRAME("openfl._legacy.text.TextField","set_wordWrap",0xc4171acf,"openfl._legacy.text.TextField.set_wordWrap","openfl/_legacy/text/TextField.hx",234,0xa9138a6d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(234)
	::openfl::_legacy::text::TextField_obj::lime_text_field_set_word_wrap(this->__handle,value);
	HX_STACK_LINE(234)
	return value;
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.text.TextField"), hx::TCanCast< TextField_obj> ,sStaticFields,sMemberFields,
...
{
	lime_text_field_create= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_create"),(int)0);
	lime_text_field_get_text= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_text"),(int)1);
	lime_text_field_set_text= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_text"),(int)2);
	lime_text_field_get_html_text= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_html_text"),(int)1);
	lime_text_field_set_html_text= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_html_text"),(int)2);
	lime_text_field_get_text_color= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_text_color"),(int)1);
	lime_text_field_set_text_color= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_text_color"),(int)2);
	lime_text_field_get_selectable= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_selectable"),(int)1);
	lime_text_field_set_selectable= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_selectable"),(int)2);
	lime_text_field_get_display_as_password= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_display_as_password"),(int)1);
	lime_text_field_set_display_as_password= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_display_as_password"),(int)2);
	lime_text_field_get_embed_fonts= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_embed_fonts"),(int)1);
	lime_text_field_set_embed_fonts= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_embed_fonts"),(int)2);
	lime_text_field_get_def_text_format= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_def_text_format"),(int)2);
	lime_text_field_set_def_text_format= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_def_text_format"),(int)2);
	lime_text_field_get_auto_size= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_auto_size"),(int)1);
	lime_text_field_set_auto_size= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_auto_size"),(int)2);
	lime_text_field_get_type= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_type"),(int)1);
	lime_text_field_set_type= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_type"),(int)2);
	lime_text_field_get_multiline= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_multiline"),(int)1);
	lime_text_field_set_multiline= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_multiline"),(int)2);
	lime_text_field_get_word_wrap= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_word_wrap"),(int)1);
	lime_text_field_set_word_wrap= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_word_wrap"),(int)2);
	lime_text_field_get_border= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_border"),(int)1);
	lime_text_field_set_border= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_border"),(int)2);
	lime_text_field_get_border_color= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_border_color"),(int)1);
	lime_text_field_set_border_color= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_border_color"),(int)2);
	lime_text_field_get_background= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_background"),(int)1);
	lime_text_field_set_background= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_background"),(int)2);
	lime_text_field_get_background_color= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_background_color"),(int)1);
	lime_text_field_set_background_color= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_background_color"),(int)2);
	lime_text_field_get_text_width= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_text_width"),(int)1);
	lime_text_field_get_text_height= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_text_height"),(int)1);
	lime_text_field_get_text_format= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_text_format"),(int)4);
	lime_text_field_set_text_format= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_text_format"),(int)4);
	lime_text_field_get_max_scroll_v= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_max_scroll_v"),(int)1);
	lime_text_field_get_max_scroll_h= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_max_scroll_h"),(int)1);
	lime_text_field_get_bottom_scroll_v= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_bottom_scroll_v"),(int)1);
	lime_text_field_get_scroll_h= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_scroll_h"),(int)1);
	lime_text_field_set_scroll_h= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_scroll_h"),(int)2);
	lime_text_field_get_scroll_v= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_scroll_v"),(int)1);
	lime_text_field_set_scroll_v= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_scroll_v"),(int)2);
	lime_text_field_get_num_lines= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_num_lines"),(int)1);
	lime_text_field_get_max_chars= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_max_chars"),(int)1);
	lime_text_field_set_max_chars= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_set_max_chars"),(int)2);
	lime_text_field_get_line_text= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_line_text"),(int)2);
	lime_text_field_get_line_metrics= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_line_metrics"),(int)3);
	lime_text_field_get_line_offset= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_text_field_get_line_offset"),(int)2);
}
