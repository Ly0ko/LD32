...
{
HX_STACK_FRAME("openfl._legacy.text.Font","new",0x95905bde,"openfl._legacy.text.Font.new","openfl/_legacy/text/Font.hx",27,0x48d29f73)
HX_STACK_THIS(this)
...
::String Font_obj::toString( ){
	HX_STACK_FRAME("openfl._legacy.text.Font","toString",0x25d1dc6e,"openfl._legacy.text.Font.toString","openfl/_legacy/text/Font.hx",132,0x48d29f73)
	HX_STACK_THIS(this)
	HX_STACK_LINE(134)
...
{
		HX_STACK_FRAME("openfl._legacy.text.Font","__fromBytes",0xb85e74ff,"openfl._legacy.text.Font.__fromBytes","openfl/_legacy/text/Font.hx",139,0x48d29f73)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.text.Font","__fromFile",0x99cf1068,"openfl._legacy.text.Font.__fromFile","openfl/_legacy/text/Font.hx",167,0x48d29f73)
		HX_STACK_THIS(this)
...
bool enumerateDeviceFonts = __o_enumerateDeviceFonts.Default(false);
	HX_STACK_FRAME("openfl._legacy.text.Font","enumerateFonts",0x85cd9342,"openfl._legacy.text.Font.enumerateFonts","openfl/_legacy/text/Font.hx",56,0x48d29f73)
		...
		if ((enumerateDeviceFonts)){
			...
			if (((::openfl::_legacy::text::Font_obj::__deviceFonts == null()))){
				...
				Void run(::String name,int style){
					HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","openfl/_legacy/text/Font.hx",66,0x48d29f73)
...
::openfl::_legacy::text::Font Font_obj::fromBytes( ::openfl::_legacy::utils::ByteArray bytes){
	HX_STACK_FRAME("openfl._legacy.text.Font","fromBytes",0x3b68309f,"openfl._legacy.text.Font.fromBytes","openfl/_legacy/text/Font.hx",79,0x48d29f73)
	HX_STACK_ARG(bytes,"bytes")
	HX_STACK_LINE(81)
...
::openfl::_legacy::text::Font Font_obj::fromFile( ::String path){
	HX_STACK_FRAME("openfl._legacy.text.Font","fromFile",0x8eeaa8c8,"openfl._legacy.text.Font.fromFile","openfl/_legacy/text/Font.hx",88,0x48d29f73)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(90)
	::openfl::_legacy::text::Font font = ::openfl::_legacy::text::Font_obj::__new(null(),null(),null());		HX_STACK_VAR(font,"font");
	HX_STACK_LINE(91)
...
Dynamic Font_obj::load( ::String filename){
	HX_STACK_FRAME("openfl._legacy.text.Font","load",0x47751ce8,"openfl._legacy.text.Font.load","openfl/_legacy/text/Font.hx",97,0x48d29f73)
...
Dynamic Font_obj::loadBytes( ::openfl::_legacy::utils::ByteArray bytes){
	HX_STACK_FRAME("openfl._legacy.text.Font","loadBytes",0xa2169263,"openfl._legacy.text.Font.loadBytes","openfl/_legacy/text/Font.hx",105,0x48d29f73)
	HX_STACK_ARG(bytes,"bytes")
	HX_STACK_LINE(107)
...
{
		HX_STACK_FRAME("openfl._legacy.text.Font","registerFont",0xb6b0b294,"openfl._legacy.text.Font.registerFont","openfl/_legacy/text/Font.hx",113,0x48d29f73)
...
void Font_obj::__boot()
{
	...
	freetype_import_font= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("freetype_import_font"),(int)4);
	lime_font_register_font= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_font_register_font"),(int)2);
	lime_font_iterate_device_fonts= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_font_iterate_device_fonts"),(int)1);
}
