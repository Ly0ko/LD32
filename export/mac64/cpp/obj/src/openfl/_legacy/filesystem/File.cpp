...
{
HX_STACK_FRAME("openfl._legacy.filesystem.File","new",0x623bfe8d,"openfl._legacy.filesystem.File.new","openfl/_legacy/filesystem/File.hx",30,0x0d6c1524)
HX_STACK_THIS(this)
...
::String File_obj::set_nativePath( ::String value){
	HX_STACK_FRAME("openfl._legacy.filesystem.File","set_nativePath",0x32e83a8c,"openfl._legacy.filesystem.File.set_nativePath","openfl/_legacy/filesystem/File.hx",52,0x0d6c1524)
	HX_STACK_THIS(this)
...
::String File_obj::set_url( ::String value){
	HX_STACK_FRAME("openfl._legacy.filesystem.File","set_url",0xe76ecdbf,"openfl._legacy.filesystem.File.set_url","openfl/_legacy/filesystem/File.hx",60,0x0d6c1524)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(62)
	if (((value == null()))){
...
::openfl::_legacy::filesystem::File File_obj::get_applicationDirectory( ){
	HX_STACK_FRAME("openfl._legacy.filesystem.File","get_applicationDirectory",0xe0457f39,"openfl._legacy.filesystem.File.get_applicationDirectory","openfl/_legacy/filesystem/File.hx",45,0x0d6c1524)
	HX_STACK_LINE(45)
...
::openfl::_legacy::filesystem::File File_obj::get_applicationStorageDirectory( ){
	HX_STACK_FRAME("openfl._legacy.filesystem.File","get_applicationStorageDirectory",0x22a09866,"openfl._legacy.filesystem.File.get_applicationStorageDirectory","openfl/_legacy/filesystem/File.hx",46,0x0d6c1524)
	HX_STACK_LINE(46)
...
::openfl::_legacy::filesystem::File File_obj::get_desktopDirectory( ){
	HX_STACK_FRAME("openfl._legacy.filesystem.File","get_desktopDirectory",0xf740e52d,"openfl._legacy.filesystem.File.get_desktopDirectory","openfl/_legacy/filesystem/File.hx",47,0x0d6c1524)
	HX_STACK_LINE(47)
...
::openfl::_legacy::filesystem::File File_obj::get_documentsDirectory( ){
	HX_STACK_FRAME("openfl._legacy.filesystem.File","get_documentsDirectory",0x14a6a591,"openfl._legacy.filesystem.File.get_documentsDirectory","openfl/_legacy/filesystem/File.hx",48,0x0d6c1524)
	HX_STACK_LINE(48)
...
::openfl::_legacy::filesystem::File File_obj::get_userDirectory( ){
	HX_STACK_FRAME("openfl._legacy.filesystem.File","get_userDirectory",0xea40ece6,"openfl._legacy.filesystem.File.get_userDirectory","openfl/_legacy/filesystem/File.hx",49,0x0d6c1524)
	HX_STACK_LINE(49)
...
void File_obj::__boot()
{
	...
	DOCS= (int)3;
	USER= (int)4;
	lime_filesystem_get_special_dir= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_filesystem_get_special_dir"),(int)1);
}
