...
{
HX_STACK_FRAME("openfl._legacy.display.ManagedStage","new",0x52468401,"openfl._legacy.display.ManagedStage.new","openfl/_legacy/display/ManagedStage.hx",42,0x768356ec)
HX_STACK_THIS(this)
...
Void run(){
{
		HX_STACK_FRAME("openfl._legacy.display.ManagedStage","beginRender",0xa9800b00,"openfl._legacy.display.ManagedStage.beginRender","openfl/_legacy/display/ManagedStage.hx",49,0x768356ec)
		HX_STACK_THIS(this)
	}
return null();
}
...
Void run(){
{
		HX_STACK_FRAME("openfl._legacy.display.ManagedStage","endRender",0x41865bf2,"openfl._legacy.display.ManagedStage.endRender","openfl/_legacy/display/ManagedStage.hx",56,0x768356ec)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl._legacy.display.ManagedStage","pumpEvent",0xefb4ecb3,"openfl._legacy.display.ManagedStage.pumpEvent","openfl/_legacy/display/ManagedStage.hx",65,0x768356ec)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.display.ManagedStage","resize",0xb565e0f3,"openfl._legacy.display.ManagedStage.resize","openfl/_legacy/display/ManagedStage.hx",72,0x768356ec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(width,"width")
		HX_STACK_ARG(height,"height")
		struct _Function_1_1{
			inline static Dynamic Block( int &width,int &height){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/ManagedStage.hx",72,0x768356ec)
				{
...
{
		HX_STACK_FRAME("openfl._legacy.display.ManagedStage","sendQuit",0x80b1c1f6,"openfl._legacy.display.ManagedStage.sendQuit","openfl/_legacy/display/ManagedStage.hx",79,0x768356ec)
		HX_STACK_THIS(this)
		struct _Function_1_1{
			inline static Dynamic Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/ManagedStage.hx",79,0x768356ec)
				{
					hx::Anon __result = hx::Anon_obj::Create();
...
{
		HX_STACK_FRAME("openfl._legacy.display.ManagedStage","setNextWake",0x3550891a,"openfl._legacy.display.ManagedStage.setNextWake","openfl/_legacy/display/ManagedStage.hx",84,0x768356ec)
		HX_STACK_THIS(this)
...
Float ManagedStage_obj::__doProcessStageEvent( Dynamic event){
	HX_STACK_FRAME("openfl._legacy.display.ManagedStage","__doProcessStageEvent",0x9c9f5081,"openfl._legacy.display.ManagedStage.__doProcessStageEvent","openfl/_legacy/display/ManagedStage.hx",91,0x768356ec)
	HX_STACK_THIS(this)
	HX_STACK_ARG(event,"event")
	HX_STACK_LINE(93)
	this->__pollTimers();
...
{
		HX_STACK_FRAME("openfl._legacy.display.ManagedStage","__render",0x4f325b35,"openfl._legacy.display.ManagedStage.__render","openfl/_legacy/display/ManagedStage.hx",103,0x768356ec)
		HX_STACK_THIS(this)
...
void ManagedStage_obj::__boot()
{
	...
	lime_managed_stage_create= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_managed_stage_create"),(int)3);
	lime_managed_stage_pump_event= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_managed_stage_pump_event"),(int)2);
}
