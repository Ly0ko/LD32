...
{
	lime_display_object_set_mouse_enabled= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_display_object_set_mouse_enabled"),(int)2);
	lime_display_object_set_needs_soft_keyboard= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_display_object_set_needs_soft_keyboard"),(int)2);
	lime_display_object_get_needs_soft_keyboard= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_display_object_get_needs_soft_keyboard"),(int)1);
	lime_display_object_set_moves_for_soft_keyboard= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_display_object_set_moves_for_soft_keyboard"),(int)2);
	lime_display_object_get_moves_for_soft_keyboard= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_display_object_get_moves_for_soft_keyboard"),(int)1);
	lime_display_object_dismiss_soft_keyboard= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_display_object_dismiss_soft_keyboard"),(int)1);
	lime_display_object_request_soft_keyboard= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_display_object_request_soft_keyboard"),(int)1);
}
