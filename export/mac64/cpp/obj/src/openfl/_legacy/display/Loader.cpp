...
{
		HX_STACK_FRAME("openfl._legacy.display.Loader","unload",0x60bec24a,"openfl._legacy.display.Loader.unload","openfl/_legacy/display/Loader.hx",60,0x567a0778)
		HX_STACK_THIS(this)
		HX_STACK_LINE(62)
...
bool Loader_obj::__onComplete( ::openfl::_legacy::utils::ByteArray bytes){
	HX_STACK_FRAME("openfl._legacy.display.Loader","__onComplete",0x75dcfba3,"openfl._legacy.display.Loader.__onComplete","openfl/_legacy/display/Loader.hx",90,0x567a0778)
	HX_STACK_THIS(this)
	HX_STACK_ARG(bytes,"bytes")
	HX_STACK_LINE(92)
	if (((bytes == null()))){
...
{
		HX_STACK_FRAME("openfl._legacy.display.Loader","contentLoaderInfo_onData",0xe2fdc719,"openfl._legacy.display.Loader.contentLoaderInfo_onData","openfl/_legacy/display/Loader.hx",130,0x567a0778)
		HX_STACK_THIS(this)
