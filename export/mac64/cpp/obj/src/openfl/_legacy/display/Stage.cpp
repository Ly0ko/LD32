...
{
		HX_STACK_FRAME("openfl._legacy.display.Stage","__render",0x60ee6dd6,"openfl._legacy.display.Stage.__render","openfl/_legacy/display/Stage.hx",1060,0x8b30a073)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.display.Stage","__setActive",0xaa514488,"openfl._legacy.display.Stage.__setActive","openfl/_legacy/display/Stage.hx",1088,0x8b30a073)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.display.Stage","__startDrag",0x2fc732f6,"openfl._legacy.display.Stage.__startDrag","openfl/_legacy/display/Stage.hx",1136,0x8b30a073)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.display.Stage","__stopDrag",0x2e151396,"openfl._legacy.display.Stage.__stopDrag","openfl/_legacy/display/Stage.hx",1169,0x8b30a073)
		HX_STACK_THIS(this)
		HX_STACK_ARG(sprite,"sprite")
		HX_STACK_LINE(1171)
...
Float Stage_obj::__updateNextWake( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","__updateNextWake",0xb4347860,"openfl._legacy.display.Stage.__updateNextWake","openfl/_legacy/display/Stage.hx",1177,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1182)
	...
	struct _Function_1_1{
		inline static bool Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/Stage.hx",1190,0x8b30a073)
			{
				HX_STACK_LINE(1190)
...
::openfl::display::StageAlign Stage_obj::get_align( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_align",0xd4898fbc,"openfl._legacy.display.Stage.get_align","openfl/_legacy/display/Stage.hx",1211,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1213)
...
::openfl::display::StageAlign Stage_obj::set_align( ::openfl::display::StageAlign value){
	HX_STACK_FRAME("openfl._legacy.display.Stage","set_align",0xb7da7bc8,"openfl._legacy.display.Stage.set_align","openfl/_legacy/display/Stage.hx",1219,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1221)
...
int Stage_obj::get_color( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_color",0xfd54aa5a,"openfl._legacy.display.Stage.get_color","openfl/_legacy/display/Stage.hx",1229,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1229)
...
int Stage_obj::set_color( int value){
	HX_STACK_FRAME("openfl._legacy.display.Stage","set_color",0xe0a59666,"openfl._legacy.display.Stage.set_color","openfl/_legacy/display/Stage.hx",1236,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1236)
...
::openfl::display::StageDisplayState Stage_obj::get_displayState( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_displayState",0xe50f3058,"openfl._legacy.display.Stage.get_displayState","openfl/_legacy/display/Stage.hx",1241,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1243)
...
::openfl::display::StageDisplayState Stage_obj::set_displayState( ::openfl::display::StageDisplayState value){
	HX_STACK_FRAME("openfl._legacy.display.Stage","set_displayState",0x3b511dcc,"openfl._legacy.display.Stage.set_displayState","openfl/_legacy/display/Stage.hx",1249,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1251)
	int _g = value->__Index();		HX_STACK_VAR(_g,"_g");
...
Float Stage_obj::get_dpiScale( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_dpiScale",0xafcc2556,"openfl._legacy.display.Stage.get_dpiScale","openfl/_legacy/display/Stage.hx",1259,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1259)
...
::openfl::_legacy::display::InteractiveObject Stage_obj::get_focus( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_focus",0xb78198cf,"openfl._legacy.display.Stage.get_focus","openfl/_legacy/display/Stage.hx",1264,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1266)
...
::openfl::_legacy::display::InteractiveObject Stage_obj::set_focus( ::openfl::_legacy::display::InteractiveObject value){
	HX_STACK_FRAME("openfl._legacy.display.Stage","set_focus",0x9ad284db,"openfl._legacy.display.Stage.set_focus","openfl/_legacy/display/Stage.hx",1273,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1275)
	if (((value == null()))){
...
Float Stage_obj::set_frameRate( Float value){
	HX_STACK_FRAME("openfl._legacy.display.Stage","set_frameRate",0xb5987430,"openfl._legacy.display.Stage.set_frameRate","openfl/_legacy/display/Stage.hx",1290,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1292)
...
bool Stage_obj::get_isOpenGL( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_isOpenGL",0x993c5f62,"openfl._legacy.display.Stage.get_isOpenGL","openfl/_legacy/display/Stage.hx",1302,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1302)
...
::openfl::_legacy::display::StageQuality Stage_obj::get_quality( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_quality",0xd07da976,"openfl._legacy.display.Stage.get_quality","openfl/_legacy/display/Stage.hx",1307,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1309)
...
::openfl::_legacy::display::StageQuality Stage_obj::set_quality( ::openfl::_legacy::display::StageQuality value){
	HX_STACK_FRAME("openfl._legacy.display.Stage","set_quality",0xdaeab082,"openfl._legacy.display.Stage.set_quality","openfl/_legacy/display/Stage.hx",1315,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1317)
	int _g = value->__Index();		HX_STACK_VAR(_g,"_g");
...
::openfl::display::StageScaleMode Stage_obj::get_scaleMode( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_scaleMode",0x63415b84,"openfl._legacy.display.Stage.get_scaleMode","openfl/_legacy/display/Stage.hx",1323,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1325)
...
::openfl::display::StageScaleMode Stage_obj::set_scaleMode( ::openfl::display::StageScaleMode value){
	HX_STACK_FRAME("openfl._legacy.display.Stage","set_scaleMode",0xa8473d90,"openfl._legacy.display.Stage.set_scaleMode","openfl/_legacy/display/Stage.hx",1331,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1333)
	int _g = value->__Index();		HX_STACK_VAR(_g,"_g");
...
::openfl::_legacy::geom::Rectangle Stage_obj::get_softKeyboardRect( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_softKeyboardRect",0xfbefc1de,"openfl._legacy.display.Stage.get_softKeyboardRect","openfl/_legacy/display/Stage.hx",1339,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1341)
...
::openfl::_legacy::display::Stage Stage_obj::get_stage( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_stage",0x3703a3b5,"openfl._legacy.display.Stage.get_stage","openfl/_legacy/display/Stage.hx",1374,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1374)
...
bool Stage_obj::get_stageFocusRect( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_stageFocusRect",0x749c42a7,"openfl._legacy.display.Stage.get_stageFocusRect","openfl/_legacy/display/Stage.hx",1379,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1379)
...
bool Stage_obj::set_stageFocusRect( bool value){
	HX_STACK_FRAME("openfl._legacy.display.Stage","set_stageFocusRect",0x514b751b,"openfl._legacy.display.Stage.set_stageFocusRect","openfl/_legacy/display/Stage.hx",1380,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1382)
...
bool Stage_obj::get_autos3d( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_autos3d",0x29c644ac,"openfl._legacy.display.Stage.get_autos3d","openfl/_legacy/display/Stage.hx",1388,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1388)
...
bool Stage_obj::set_autos3d( bool value){
	HX_STACK_FRAME("openfl._legacy.display.Stage","set_autos3d",0x34334bb8,"openfl._legacy.display.Stage.set_autos3d","openfl/_legacy/display/Stage.hx",1389,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1391)
...
int Stage_obj::get_stageHeight( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_stageHeight",0xa36d557c,"openfl._legacy.display.Stage.get_stageHeight","openfl/_legacy/display/Stage.hx",1397,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1399)
...
int Stage_obj::get_stageWidth( ){
	HX_STACK_FRAME("openfl._legacy.display.Stage","get_stageWidth",0x6615f211,"openfl._legacy.display.Stage.get_stageWidth","openfl/_legacy/display/Stage.hx",1404,0x8b30a073)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1406)
	Float _g;		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1406)
...
void Stage_obj::__boot()
{
	...
	lime_set_stage_handler= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_set_stage_handler"),(int)4);
	lime_render_stage= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_render_stage"),(int)1);
	lime_stage_get_autos3d= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_autos3d"),(int)1);
	lime_stage_set_autos3d= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_set_autos3d"),(int)2);
	lime_stage_get_focus_id= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_focus_id"),(int)1);
	lime_stage_set_focus= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_set_focus"),(int)3);
	lime_stage_get_focus_rect= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_focus_rect"),(int)1);
	lime_stage_set_focus_rect= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_set_focus_rect"),(int)2);
	lime_stage_is_opengl= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_is_opengl"),(int)1);
	lime_stage_get_stage_width= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_stage_width"),(int)1);
	lime_stage_get_stage_height= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_stage_height"),(int)1);
	lime_stage_get_dpi_scale= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_dpi_scale"),(int)1);
	lime_stage_get_scale_mode= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_scale_mode"),(int)1);
	lime_stage_set_scale_mode= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_set_scale_mode"),(int)2);
	lime_stage_get_align= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_align"),(int)1);
	lime_stage_set_align= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_set_align"),(int)2);
	lime_stage_get_quality= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_quality"),(int)1);
	lime_stage_set_quality= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_set_quality"),(int)2);
	lime_stage_get_display_state= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_display_state"),(int)1);
	lime_stage_set_display_state= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_set_display_state"),(int)2);
	lime_stage_set_next_wake= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_set_next_wake"),(int)2);
	lime_stage_request_render= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_request_render"),(int)0);
	lime_stage_resize_window= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_resize_window"),(int)3);
	lime_stage_set_resolution= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_set_resolution"),(int)3);
	lime_stage_set_screenmode= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_set_screenmode"),(int)5);
	lime_stage_set_fullscreen= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_set_fullscreen"),(int)2);
	lime_stage_show_cursor= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_show_cursor"),(int)2);
	lime_stage_set_fixed_orientation= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_set_fixed_orientation"),(int)1);
	lime_stage_get_orientation= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_orientation"),(int)0);
	lime_stage_get_normal_orientation= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_stage_get_normal_orientation"),(int)0);
}
