...
{
HX_STACK_FRAME("openfl._legacy.display.OptimizedPerlin","new",0x2e02d39d,"openfl._legacy.display.OptimizedPerlin.new","openfl/_legacy/display/BitmapData.hx",930,0x0b92a012)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.display.OptimizedPerlin","fill",0x0f2fa0a6,"openfl._legacy.display.OptimizedPerlin.fill","openfl/_legacy/display/BitmapData.hx",940,0x0b92a012)
		HX_STACK_THIS(this)
							...
							while((true)){
								...
								struct _Function_7_1{
									inline static Float Block( int &hash,Float &x1,Float &y1){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/BitmapData.hx",1003,0x0b92a012)
										{
											HX_STACK_LINE(1003)
								...
								struct _Function_7_3{
									inline static Float Block( int &hash,Float &x,Float &y1){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/BitmapData.hx",1006,0x0b92a012)
										{
											HX_STACK_LINE(1006)
								...
								struct _Function_7_5{
									inline static Float Block( int &hash,Float &x1,Float &y){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/BitmapData.hx",1009,0x0b92a012)
										{
											HX_STACK_LINE(1009)
								...
								struct _Function_7_7{
									inline static Float Block( int &hash,Float &x,Float &y){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/BitmapData.hx",1012,0x0b92a012)
										{
											HX_STACK_LINE(1012)
								...
								struct _Function_7_9{
									inline static Float Block( int &hash,Float &x1,Float &y1){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/BitmapData.hx",1015,0x0b92a012)
										{
											HX_STACK_LINE(1015)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y1) );
										}
								...
								struct _Function_7_11{
									inline static Float Block( int &hash,Float &x,Float &y1){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/BitmapData.hx",1018,0x0b92a012)
										{
											HX_STACK_LINE(1018)
											return (  (((hash < (int)8))) ? Float(x) : Float(y1) );
										}
								...
								struct _Function_7_13{
									inline static Float Block( int &hash,Float &x1,Float &y){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/BitmapData.hx",1021,0x0b92a012)
										{
											HX_STACK_LINE(1021)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y) );
										}
								...
								struct _Function_7_15{
									inline static Float Block( int &hash,Float &x,Float &y){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/display/BitmapData.hx",1024,0x0b92a012)
										{
											HX_STACK_LINE(1024)
											return (  (((hash < (int)8))) ? Float(x) : Float(y) );
										}
...
{
		HX_STACK_FRAME("openfl._legacy.display.OptimizedPerlin","octFreqPers",0xaeeba70b,"openfl._legacy.display.OptimizedPerlin.octFreqPers","openfl/_legacy/display/BitmapData.hx",1054,0x0b92a012)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._legacy.display.OptimizedPerlin","seedOffset",0xad5c4a47,"openfl._legacy.display.OptimizedPerlin.seedOffset","openfl/_legacy/display/BitmapData.hx",1077,0x0b92a012)
		HX_STACK_THIS(this)
