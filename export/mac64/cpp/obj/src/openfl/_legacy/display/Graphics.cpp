...
void Graphics_obj::__boot()
{
	...
	lime_gfx_clear= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_clear"),(int)1);
	lime_gfx_begin_fill= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_begin_fill"),(int)3);
	lime_gfx_begin_bitmap_fill= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_begin_bitmap_fill"),(int)5);
	lime_gfx_line_bitmap_fill= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_line_bitmap_fill"),(int)5);
	lime_gfx_begin_gradient_fill= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_begin_gradient_fill"),(int)-1);
	lime_gfx_line_gradient_fill= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_line_gradient_fill"),(int)-1);
	lime_gfx_end_fill= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_end_fill"),(int)1);
	lime_gfx_line_style= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_line_style"),(int)-1);
	lime_gfx_move_to= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_move_to"),(int)3);
	lime_gfx_line_to= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_line_to"),(int)3);
	lime_gfx_curve_to= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_curve_to"),(int)5);
	lime_gfx_arc_to= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_arc_to"),(int)5);
	lime_gfx_draw_ellipse= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_draw_ellipse"),(int)5);
	lime_gfx_draw_data= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_draw_data"),(int)2);
	lime_gfx_draw_datum= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_draw_datum"),(int)2);
	lime_gfx_draw_rect= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_draw_rect"),(int)5);
	lime_gfx_draw_path= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_draw_path"),(int)4);
	lime_gfx_draw_tiles= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_draw_tiles"),(int)5);
	lime_gfx_draw_points= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_draw_points"),(int)-1);
	lime_gfx_draw_round_rect= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_draw_round_rect"),(int)-1);
	lime_gfx_draw_triangles= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_gfx_draw_triangles"),(int)-1);
}
