...
{
	lime_direct_renderer_create= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_direct_renderer_create"),(int)0);
	lime_direct_renderer_set= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_direct_renderer_set"),(int)2);
}
