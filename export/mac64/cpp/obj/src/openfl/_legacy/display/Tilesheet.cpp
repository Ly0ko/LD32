...
HX_STACK_ARG(image,"image")
{
	...
	this->__bitmap = image;
	HX_STACK_LINE(42)
	Dynamic _g = ::openfl::_legacy::display::Tilesheet_obj::lime_tilesheet_create(image->__handle);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(42)
	this->__handle = _g;
	HX_STACK_LINE(44)
...
int Tilesheet_obj::addTileRect( ::openfl::_legacy::geom::Rectangle rectangle,::openfl::_legacy::geom::Point centerPoint){
	...
	if (((centerPoint == null()))){
		HX_STACK_LINE(57)
		this->_tilePoints->push(::openfl::_legacy::display::Tilesheet_obj::defaultRatio);
	}
	else{
		HX_STACK_LINE(58)
		::openfl::_legacy::geom::Point _g = ::openfl::_legacy::geom::Point_obj::__new((Float(centerPoint->x) / Float(rectangle->width)),(Float(centerPoint->y) / Float(rectangle->height)));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(58)
	...
	HX_STACK_LINE(59)
	::openfl::_legacy::geom::Rectangle _g9 = ::openfl::_legacy::geom::Rectangle_obj::__new(_g2,_g4,_g6,_g8);		HX_STACK_VAR(_g9,"_g9");
	HX_STACK_LINE(59)
	this->_tileUVs->push(_g9);
	HX_STACK_LINE(60)
	return ::openfl::_legacy::display::Tilesheet_obj::lime_tilesheet_add_rect(this->__handle,rectangle,centerPoint);
}
...
::openfl::_legacy::geom::Point Tilesheet_obj::getTileCenter( int index){
	...
	HX_STACK_LINE(73)
	return this->_tilePoints->__get(index).StaticCast< ::openfl::_legacy::geom::Point >();
}
...
::openfl::_legacy::geom::Rectangle Tilesheet_obj::getTileRect( int index){
	...
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(77)
	return this->_tiles->__get(index).StaticCast< ::openfl::_legacy::geom::Rectangle >();
}
...
::openfl::_legacy::geom::Rectangle Tilesheet_obj::getTileUVs( int index){
	...
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(81)
	return this->_tileUVs->__get(index).StaticCast< ::openfl::_legacy::geom::Rectangle >();
}
...
Dynamic Tilesheet_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"defaultRatio") ) { defaultRatio=inValue.Cast< ::openfl::_legacy::geom::Point >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_legacy::display::BitmapData*/ ,(int)offsetof(Tilesheet_obj,__bitmap),HX_CSTRING("__bitmap")},
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.display.Tilesheet"), hx::TCanCast< Tilesheet_obj> ,sStaticFields,sMemberFields,
...
void Tilesheet_obj::__boot()
{
	...
	lime_tilesheet_create= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_tilesheet_create"),(int)1);
	lime_tilesheet_add_rect= ::openfl::_legacy::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_tilesheet_add_rect"),(int)3);
}
